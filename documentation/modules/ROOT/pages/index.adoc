...
* xref:schema:attachment$dp_capaciteitskaart.json_schema.json[JSON schema]
* xref:schema:example$dp_capaciteitskaart_dso.example.json[Example DSO instance data]
* xref:schema:example$dp_capaciteitskaart_tso.example.json[Example TSO instance data]
