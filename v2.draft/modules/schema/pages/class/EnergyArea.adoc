...
EnergyArea -> CongestionInfo: congestion_info
...
//| [[slots_table.congestion_info]]<<congestion_info,`congestion_info`>>
| 0..* +
xref::class/CongestionInfo.adoc[`CongestionInfo`]
| +++Additional (congestion) information for this EnergyArea. Use this to add multiple documentation and/or descriptions.+++
| _n/a_
...
| +++URL for additional (congestion) information for this EnergyArea. Only use this attribute if only one URL is required....+++
| _n/a_
...
|===
| URI
| `this:EnergyArea.CongestionInfo`
| Cardinality
| 0..*
| Type
| xref::class/CongestionInfo.adoc[`CongestionInfo`]
...
[#congestion_url]
=== `congestion_url`
+++URL for additional (congestion) information for this EnergyArea. Only use this attribute if only one URL is required. Otherwise, add more congestion information using this:EnergyArea.CongestionInfo.+++


[cols="h,4",width=65%]
|===
| URI
| `this:EnergyArea.congestionURL`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
